...
function Users() {
    ...
    const { data: groupedUsers, isLoading: gettingUsersLoading, error: gettingUsersError } = useApiGet('/account/getAll', { groupBy: 'role' }, queryKey);
    const users = useMemo(() => {
    ...
    return (
        <div className=' grow h-full flex flex-col justify-between items-center p-4.5'>
            ...
            <TableDisplayLayout tableHeadValuesArr={tableHeadValuesArr} tableHeadSpaceingArr={tableHeadSpaceingArr} sensativeData={sensativeData}>
